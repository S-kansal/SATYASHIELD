...
# ------------------ Title Section ------------------
st.markdown("<div class='main-title'>SATYASHIELD</div>", unsafe_allow_html=True)
...
# ------------------ Footer ------------------
st.markdown("<div class='footer'>Developed by <b>Hansika Singh</b></div>", unsafe_allow_html=True)
